/// GUN 18: Object'leri (Nesneleri) Alma ve Durumu Guncelleme - COZUM
///
/// Bu cozum dosyasidir.
...
module challenge::day_18_solution {
    ...
    // day_17'den Farm ve tum fonksiyonlari kopyala
    ...
    // Farm uzerinde ekim yapmak icin entry function (giris fonksiyonu)
    entry fun plant_on_farm_entry(farm: &mut Farm, plotId: u8) {
        plant_on_farm(farm, plotId);
    }

    // Farm'dan hasat yapmak icin entry function (giris fonksiyonu)
